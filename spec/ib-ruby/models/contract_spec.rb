...
describe IB::Models::Contract::Details do
  ...
  context "instantiation" do
    context 'empty without properties' do
      subject { IB::Models::Contract::Details.new }
    ...
    context 'with properties' do
      subject { IB::Models::Contract::Details.new properties }
    ...
    it 'allows setting attributes' do
      expect {
        x = IB::Models::Contract::Details.new
        x.callable = true
        x.puttable = true
        x.convertible = true
        x.under_con_id = 321
...
end # describe IB::Models::Contract::Details
