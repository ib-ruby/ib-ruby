...
/**
 * This class represents a trade tick.
 */
public final class TradeTick extends Tick {
    ...
    TradeTick(Date timestamp, double price, int size) {
        super(timestamp);
        this.mPrice = price;
        this.mSize = size;
    }
    ...
    public final String toString() {
        return super.toString() + "T" + "," + mPrice + "," + mSize;
    }
