...
/**
 * This class represents an open tick (the opening value at the start of the current trading session).
 */
public final class OpenTick extends Tick {
    ...
    OpenTick(Date timestamp, double price) {
        super(timestamp);
        this.mPrice = price;
    }
    ...
    public final String toString() {
        return super.toString() + "O" + "," + mPrice;
    }
