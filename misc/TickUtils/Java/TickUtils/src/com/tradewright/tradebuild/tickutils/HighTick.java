...
/**
 * This class represents a high tick (the highest value reached during the current trading session).
 */
public final class HighTick extends Tick {
    ...
    HighTick(Date timestamp, double price) {
        super(timestamp);
        this.mPrice = price;
    }
    ...
    public final String toString() {
        return super.toString() + "H" + "," + mPrice;
    }
