...
/**
 * This class represents a close tick (the closing value for the previous trading session).
 */
public final class CloseTick extends Tick {
    ...
    CloseTick(Date timestamp, double price) {
        super(timestamp);
        this.mPrice = price;
    }
    ...
    public final String toString() {
        return super.toString() + "C" + "," + mPrice;
    }
