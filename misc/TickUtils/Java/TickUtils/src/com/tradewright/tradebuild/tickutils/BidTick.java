...
/**
 * This class represents a bid tick.
 */
public final class BidTick extends Tick {
    ...
    BidTick(Date timestamp, double price, int size) {
        super(timestamp);
        this.mPrice = price;
        this.mSize = size;
    }
    ...
    public final String toString() {
        return super.toString() + "B" + "," + mPrice + "," + mSize;
    }
